...
export type Klus = { id: string; nummer: string; klant: string; telefoon?: string; voertuig: string; klacht: string; bedrag: number; geoffreerdeArbeid?: number; datum: string; getekend: string; status?: "geaccepteerd" | "gefactureerd" };
