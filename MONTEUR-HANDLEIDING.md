# Werkbonnen app, korte handleiding

**Adres:** revisio-umber.vercel.app/werkbonnen

## Inloggen
1. Vul je e-mailadres in en tik op "Stuur inlogcode".
2. Je krijgt een mail met een code. Typ die code in de app.
3. Klaar. (Op de computer kun je ook gewoon de link in de mail aanklikken.)

Werkt het niet? Check je spam, of vraag een nieuwe code aan.

## Een klus doen
1. Tik op een klus in de lijst.
2. Start de timer als je begint, stop als je klaar bent.
3. Vink per fase het stadium af (Ontvangst, Demontage, Ultrasoon, Heropbouwen, Eindcontrole).
