...
// Demo-foto's: tijdelijk de publieke foto's van een echte revisie.
const F = "https://ntcbrqoesjlgiawmkdsa.supabase.co/storage/v1/object/public/werkbon-fotos/2026-0566";
const STADIA = [
  { label: "Ontvangen", oms: "We hebben je carburateur goed ontvangen en op de werkbank gelegd.", foto: `${F}/ontvangen/1781344012440.jpg`, pct: 20 },
  { label: "Diagnose", oms: "We zijn begonnen: inspectie en analyse van alle onderdelen.", foto: `${F}/gestart/1781346357956.jpg`, pct: 40 },
  { label: "Reviseren", oms: "Demontage, ultrasoonreiniging en de onderdelen plaatsen.", foto: `${F}/voor_ultrasoon/1781354974808.jpg`, pct: 60 },
  { label: "Afbouwen en aftesten", oms: "We bouwen de carburateur af en testen op vacuum en benzinedruk.", foto: `${F}/voor_ultrasoon/1781354988151.jpg`, pct: 80 },
  { label: "Klaar om op te halen", oms: "Je revisie is afgerond, afgesteld en gecontroleerd.", foto: `${F}/schoon/1781359590611.jpg`, pct: 100 },
];
                  ...
                  <div style={{
                    ...
                    {done && (
                      <div style={{ marginTop: 13 }}>
                        <img src={st.foto} alt="" style={{ width: 120, height: 120, objectFit: "cover", borderRadius: 12, border: `1px solid ${RAND}`, display: "block" }} />
                      </div>
                    )}
                  </div>
                </div>
